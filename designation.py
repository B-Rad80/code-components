...
def getDesignation(countyCode, tractCode):
    ...
    conn = psycopg2.connect(database="hub_designations", user="django",
                            password="DUHJANGO", host="127.0.0.1", port="5432")

    # conn = psycopg2.connect(database="hub_designations", user="hub", password="DUHJANGO",host="127.0.0.1", port="5432")  # specifies connection details
